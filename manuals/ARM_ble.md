...
- Minimum hardware and software requirements are: 1CPU, 512MB RAM, 8GB disk space, network connection, Raspberry Pi OS | Debian 12 operating system;
...
$ sudo pip3 install bluepy garminconnect --break-system-packages
```
