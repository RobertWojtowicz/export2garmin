...
class deviceSpecificDriver(sharedDeviceDriverCode):
    ...
    def deviceSpecific_syncWithSystemTime(self):
        ...
        setNewTimeDataBytes += bytes([sum(setNewTimeDataBytes) & 0xff, 0x00])           #first byte is crc generated by sum over data and only using lower 8 bits, second byte does not seem to matter
